...
public class PlayObjects extends JPanel {
	...
	private void doDrawing(Graphics g) {
		...
		Rectangle2D paddle = new Rectangle2D.Double(paddleX, 355, Block223Application.getCurrentPlayableGame().getCurrentPaddleLength(), PADDLE_HEIGHT); 
		g2d.fill(paddle);
		...
		ball = new Ellipse2D.Double(ball_x - (BALL_DIAMETER/2), ball_y - (BALL_DIAMETER/2), BALL_DIAMETER, BALL_DIAMETER);
