...
public class PlayedGame implements Serializable
{
  ...
  private void doSetup(){
    ...
    public BouncePoint calculateBouncePointPaddle() {
        ...
        if (ballDirectionX > 0) {
            if (intersectsB) {
                double bouncePointY = ((currentPaddleX - 5 - currentBallX) * ballDirectionY) / ballDirectionX + currentBallY;
            ...
            if (intersectsA) {
                double bouncePointX = ((currentPaddleY - 5 - currentBallY) * ballDirectionX) / ballDirectionY + currentBallX;
            ...
            if (intersectsC) {
                double bouncePointY = ((currentPaddleX + currentPaddleLength + 5 - currentBallX) * ballDirectionY) / ballDirectionX + currentBallY;
    ...
    public BouncePoint calculateBouncePointWall() {
        if ((currentBallY + ballDirectionY) <= 5) {
            double bouncePointX = ((5 - currentBallY) * ballDirectionX) / ballDirectionY + currentBallX;
            ...
            double bouncePointY = ((5 - currentBallX) * ballDirectionY) / ballDirectionX + currentBallY;
            if (bouncePointY <= 385) {
                return new BouncePoint(5, bouncePointY, BouncePoint.BounceDirection.FLIP_X);
            }
        } else if ((currentBallX + ballDirectionX) >= 385) {

            double bouncePointY = ((385 - currentBallX) * ballDirectionY) / ballDirectionX + currentBallY;
            if (bouncePointY <= 385) {
